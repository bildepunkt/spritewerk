...
class Preloader {
    ...
    static load(...paths) {
        ...
        for (let path of paths) {
            if (Preloader._isImage(path)) {
                let img = new Preloader.window.Image();
                img.src = path;
                ...
                let audio = new Preloader.window.Audio();
                audio.src = path;
                ...
                let video = new Preloader.window.Video();
                video.src = path;
    ...
    static handleLoad(e) {
        ...
        if (Preloader.loaded === Preloader.total) {
            ...
            Preloader.onUpdate(Preloader.loaded, Preloader.total);
        }
    }
